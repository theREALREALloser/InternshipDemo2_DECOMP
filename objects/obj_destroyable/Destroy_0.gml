...
if (object_index == obj_breadbox_hidden || object_index == obj_sandwichbox_hidden)
{
...
if (object_index == obj_breadbox_big_hidden || object_index == obj_sandwichbox_big_hidden || object_index == obj_metalbox_hidden)
{
...
if (object_index == obj_metalbox_big_hidden || object_index == obj_breadbox_large_hidden)
{
    lay_id = layer_get_id("Tiles_1")
    map_id = layer_tilemap_get_id(lay_id)
...
if (object_index == obj_breadbox_giant_hidden || object_index == obj_metalbox_giant_hidden)
{
    lay_id = layer_get_id("Tiles_1")
    map_id = layer_tilemap_get_id(lay_id)
    data1 = tilemap_get_at_pixel(map_id, x, y)
