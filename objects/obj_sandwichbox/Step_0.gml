...
{
    if (obj_player.spinning == 1 || obj_player.grabbing == 1 || obj_player.state == "crouchslide" || (obj_player.state == "cheesed" && obj_player.cheesed_state == "roll") || obj_player.state == "tumble" || obj_player.state == "uppunch")
        hp--
    else if ((obj_player.state == "tackle1" || obj_player.state == "tackle2" || obj_player.state == "walljump" || obj_player.state == "superjump_kick" || obj_player.state == "sodaride" || obj_player.state == "jetpack_run" || obj_player.state == "jetpack_dash" || obj_player.state == "tumble" || obj_player.state == "snowball" || obj_player.state == "onfire") && ((obj_player.x < x && obj_player.image_xscale == 1) || (obj_player.x > x && obj_player.image_xscale == -1)))
        hp--
}
...
if (object_index == obj_sandwichbox_hidden)
