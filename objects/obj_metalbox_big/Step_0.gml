...
{
    if ((obj_player.state == "tackle2" || obj_player.state == "sodaride" || obj_player.state == "jetpack_run" || obj_player.state == "jetpack_dash") && ((obj_player.x < x && obj_player.image_xscale == 1) || (obj_player.x > x && obj_player.image_xscale == -1)))
        hp--
}
if (hp < 1)
{
...
if (object_index == obj_metalbox_big_hidden)
